...
func (e PatientEdges) PatientIDOrErr() ([]*Treatment, error) {
	if e.loadedTypes[0] {
...
func (pa *Patient) assignValues(values ...interface{}) error {
	...
	if value, ok := values[0].(*sql.NullInt64); !ok {
		return fmt.Errorf("unexpected type %T for field patient_age", values[0])
	} else if value.Valid {
...
func (pa *Patient) QueryPatientID() *TreatmentQuery {
