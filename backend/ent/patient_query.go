...
func (pq *PatientQuery) QueryPatientID() *TreatmentQuery {
...
func (pq *PatientQuery) WithPatientID(opts ...func(*TreatmentQuery)) *PatientQuery {
	query := &TreatmentQuery{config: pq.config}
...
//		GroupBy(patient.FieldPatientAge).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
//
...
//
//	client.Patient.Query().
//		Select(patient.FieldPatientAge).
//		Scan(ctx, &v)
//
