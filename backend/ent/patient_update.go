...
// AddPatientID adds the patient_id edges to Treatment.
func (pu *PatientUpdate) AddPatientID(t ...*Treatment) *PatientUpdate {
	ids := make([]int, len(t))
	for i := range t {
		ids[i] = t[i].ID
	}
...
// RemovePatientID removes patient_id edges to Treatment.
func (pu *PatientUpdate) RemovePatientID(t ...*Treatment) *PatientUpdate {
	ids := make([]int, len(t))
	for i := range t {
		ids[i] = t[i].ID
	}
...
// AddPatientID adds the patient_id edges to Treatment.
func (puo *PatientUpdateOne) AddPatientID(t ...*Treatment) *PatientUpdateOne {
	ids := make([]int, len(t))
	for i := range t {
		ids[i] = t[i].ID
	}
...
// RemovePatientID removes patient_id edges to Treatment.
func (puo *PatientUpdateOne) RemovePatientID(t ...*Treatment) *PatientUpdateOne {
	ids := make([]int, len(t))
	for i := range t {
		ids[i] = t[i].ID
	}
