...
func (uq *UserQuery) QueryDoctorID() *TreatmentQuery {
...
func (uq *UserQuery) WithDoctorID(opts ...func(*TreatmentQuery)) *UserQuery {
	query := &TreatmentQuery{config: uq.config}
