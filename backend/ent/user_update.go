...
// AddDoctorID adds the doctor_id edges to Treatment.
func (uu *UserUpdate) AddDoctorID(t ...*Treatment) *UserUpdate {
	ids := make([]int, len(t))
	for i := range t {
		ids[i] = t[i].ID
	}
...
// RemoveDoctorID removes doctor_id edges to Treatment.
func (uu *UserUpdate) RemoveDoctorID(t ...*Treatment) *UserUpdate {
	ids := make([]int, len(t))
	for i := range t {
		ids[i] = t[i].ID
	}
...
// AddDoctorID adds the doctor_id edges to Treatment.
func (uuo *UserUpdateOne) AddDoctorID(t ...*Treatment) *UserUpdateOne {
	ids := make([]int, len(t))
	for i := range t {
		ids[i] = t[i].ID
	}
...
// RemoveDoctorID removes doctor_id edges to Treatment.
func (uuo *UserUpdateOne) RemoveDoctorID(t ...*Treatment) *UserUpdateOne {
	ids := make([]int, len(t))
	for i := range t {
		ids[i] = t[i].ID
	}
