...
function ControllersTreatmentFromJSON(json) {
  return ControllersTreatmentFromJSONTyped(json);
}
function ControllersTreatmentFromJSONTyped(json, ignoreDiscriminator) {
  if (json === void 0 || json === null) {
    return json;
  }
  return {
    added: !exists(json, "added") ? void 0 : json["added"],
    patientid: !exists(json, "patientid") ? void 0 : json["patientid"],
    status: !exists(json, "status") ? void 0 : json["status"],
    symptom: !exists(json, "symptom") ? void 0 : json["symptom"],
    userid: !exists(json, "userid") ? void 0 : json["userid"]
  };
}
function ControllersTreatmentToJSON(value) {
  if (value === void 0) {
    return void 0;
  }
  if (value === null) {
...
function EntPatientFromJSON(json) {
  return EntPatientFromJSONTyped(json);
}
function EntPatientFromJSONTyped(json, ignoreDiscriminator) {
  if (json === void 0 || json === null) {
    return json;
  }
  return {
    edges: !exists(json, "edges") ? void 0 : EntPatientEdgesFromJSON(json["edges"]),
    id: !exists(json, "id") ? void 0 : json["id"],
    patientAge: !exists(json, "patient_age") ? void 0 : json["patient_age"],
    patientName: !exists(json, "patient_name") ? void 0 : json["patient_name"]
  };
}
function EntPatientToJSON(value) {
  if (value === void 0) {
    return void 0;
  }
  if (value === null) {
...
function EntPatientEdgesFromJSON(json) {
  return EntPatientEdgesFromJSONTyped(json);
}
function EntPatientEdgesFromJSONTyped(json, ignoreDiscriminator) {
  if (json === void 0 || json === null) {
    return json;
  }
  return {
    patientID: !exists(json, "patientID") ? void 0 : json["patientID"].map(EntTreatmentFromJSON)
  };
}
function EntPatientEdgesToJSON(value) {
  if (value === void 0) {
    return void 0;
  }
  if (value === null) {
  ...
  return {
    patientID: value.patientID === void 0 ? void 0 : value.patientID.map(EntTreatmentToJSON)
  };
}

function EntStatusTrackingFromJSON(json) {
  return EntStatusTrackingFromJSONTyped(json);
}
function EntStatusTrackingFromJSONTyped(json, ignoreDiscriminator) {
  if (json === void 0 || json === null) {
    return json;
  }
  return {
    edges: !exists(json, "edges") ? void 0 : EntStatusTrackingEdgesFromJSON(json["edges"]),
    id: !exists(json, "id") ? void 0 : json["id"],
    status: !exists(json, "status") ? void 0 : json["status"]
  };
}
function EntStatusTrackingToJSON(value) {
  if (value === void 0) {
    return void 0;
  }
  if (value === null) {
...
function EntStatusTrackingEdgesFromJSON(json) {
  return EntStatusTrackingEdgesFromJSONTyped(json);
}
function EntStatusTrackingEdgesFromJSONTyped(json, ignoreDiscriminator) {
  if (json === void 0 || json === null) {
    return json;
  }
  return {
    statusID: !exists(json, "statusID") ? void 0 : json["statusID"].map(EntTreatmentFromJSON)
  };
}
function EntStatusTrackingEdgesToJSON(value) {
  if (value === void 0) {
    return void 0;
  }
  if (value === null) {
  ...
  return {
    statusID: value.statusID === void 0 ? void 0 : value.statusID.map(EntTreatmentToJSON)
  };
}

function EntTreatmentFromJSON(json) {
  return EntTreatmentFromJSONTyped(json);
}
function EntTreatmentFromJSONTyped(json, ignoreDiscriminator) {
  if (json === void 0 || json === null) {
    return json;
  }
  return {
    dateAppoint: !exists(json, "date_appoint") ? void 0 : json["date_appoint"],
    edges: !exists(json, "edges") ? void 0 : EntTreatmentEdgesFromJSON(json["edges"]),
    id: !exists(json, "id") ? void 0 : json["id"],
    symptom: !exists(json, "symptom") ? void 0 : json["symptom"]
  };
}
function EntTreatmentToJSON(value) {
  if (value === void 0) {
    return void 0;
  }
  if (value === null) {
...
function EntTreatmentEdgesFromJSON(json) {
  return EntTreatmentEdgesFromJSONTyped(json);
}
function EntTreatmentEdgesFromJSONTyped(json, ignoreDiscriminator) {
  if (json === void 0 || json === null) {
    return json;
  }
  return {
    doctorID: !exists(json, "DoctorID") ? void 0 : EntUserFromJSON(json["DoctorID"]),
    patientID: !exists(json, "PatientID") ? void 0 : EntPatientFromJSON(json["PatientID"]),
    statusID: !exists(json, "StatusID") ? void 0 : EntStatusTrackingFromJSON(json["StatusID"])
  };
}
function EntTreatmentEdgesToJSON(value) {
  if (value === void 0) {
    return void 0;
  }
  if (value === null) {
...
function EntUserFromJSONTyped(json, ignoreDiscriminator) {
  ...
  return {
    doctorEmail: !exists(json, "doctor_email") ? void 0 : json["doctor_email"],
    doctorName: !exists(json, "doctor_name") ? void 0 : json["doctor_name"],
...
function EntUserEdgesFromJSONTyped(json, ignoreDiscriminator) {
  ...
  return {
    doctorID: !exists(json, "doctorID") ? void 0 : json["doctorID"].map(EntTreatmentFromJSON)
  };
}
function EntUserEdgesToJSON(value) {
  ...
  return {
    doctorID: value.doctorID === void 0 ? void 0 : value.doctorID.map(EntTreatmentToJSON)
  };
}

class DefaultApi extends BaseAPI {
  async createPatientRaw(requestParameters) {
    if (requestParameters.patient === null || requestParameters.patient === void 0) {
      throw new RequiredError("patient", "Required parameter requestParameters.patient was null or undefined when calling createPatient.");
    }
    ...
    return new JSONApiResponse(response, (jsonValue) => EntPatientFromJSON(jsonValue));
  }
  ...
  async createStatustrackingRaw(requestParameters) {
    if (requestParameters.statustracking === null || requestParameters.statustracking === void 0) {
      throw new RequiredError("statustracking", "Required parameter requestParameters.statustracking was null or undefined when calling createStatustracking.");
    }
    const queryParameters = {};
    const headerParameters = {};
    headerParameters["Content-Type"] = "application/json";
    ...
    return new JSONApiResponse(response, (jsonValue) => EntStatusTrackingFromJSON(jsonValue));
  }
  ...
  async createTreatmentRaw(requestParameters) {
    if (requestParameters.treatment === null || requestParameters.treatment === void 0) {
      throw new RequiredError("treatment", "Required parameter requestParameters.treatment was null or undefined when calling createTreatment.");
    }
    const queryParameters = {};
    const headerParameters = {};
    headerParameters["Content-Type"] = "application/json";
    ...
    return new JSONApiResponse(response, (jsonValue) => ControllersTreatmentFromJSON(jsonValue));
  }
  ...
  async deletePatientRaw(requestParameters) {
    if (requestParameters.id === null || requestParameters.id === void 0) {
      throw new RequiredError("id", "Required parameter requestParameters.id was null or undefined when calling deletePatient.");
    }
    const queryParameters = {};
    const headerParameters = {};
    const response = await this.request({
  ...
  async deleteStatustrackingRaw(requestParameters) {
    if (requestParameters.id === null || requestParameters.id === void 0) {
      throw new RequiredError("id", "Required parameter requestParameters.id was null or undefined when calling deleteStatustracking.");
    }
    const queryParameters = {};
    const headerParameters = {};
    const response = await this.request({
  ...
  async deleteTreatmentRaw(requestParameters) {
    if (requestParameters.id === null || requestParameters.id === void 0) {
      throw new RequiredError("id", "Required parameter requestParameters.id was null or undefined when calling deleteTreatment.");
    }
    const queryParameters = {};
    const headerParameters = {};
    const response = await this.request({
  ...
  async getPatientRaw(requestParameters) {
    if (requestParameters.id === null || requestParameters.id === void 0) {
      throw new RequiredError("id", "Required parameter requestParameters.id was null or undefined when calling getPatient.");
    }
    const queryParameters = {};
    const headerParameters = {};
    const response = await this.request({
  ...
  async getStatustrackingRaw(requestParameters) {
    if (requestParameters.id === null || requestParameters.id === void 0) {
      throw new RequiredError("id", "Required parameter requestParameters.id was null or undefined when calling getStatustracking.");
    }
    const queryParameters = {};
    const headerParameters = {};
    const response = await this.request({
  ...
  async getTreatmentRaw(requestParameters) {
    if (requestParameters.id === null || requestParameters.id === void 0) {
      throw new RequiredError("id", "Required parameter requestParameters.id was null or undefined when calling getTreatment.");
    }
    const queryParameters = {};
    const headerParameters = {};
    const response = await this.request({
    ...
    return new JSONApiResponse(response, (jsonValue) => EntTreatmentFromJSON(jsonValue));
  }
  ...
  async listPatientRaw(requestParameters) {
    ...
    return new JSONApiResponse(response, (jsonValue) => jsonValue.map(EntPatientFromJSON));
  }
  ...
  async listStatustrackingRaw(requestParameters) {
    ...
    return new JSONApiResponse(response, (jsonValue) => jsonValue.map(EntStatusTrackingFromJSON));
  }
  ...
  async listTreatmentRaw(requestParameters) {
    ...
    return new JSONApiResponse(response, (jsonValue) => jsonValue.map(EntTreatmentFromJSON));
  }
  ...
  async updatePatientRaw(requestParameters) {
    if (requestParameters.id === null || requestParameters.id === void 0) {
      throw new RequiredError("id", "Required parameter requestParameters.id was null or undefined when calling updatePatient.");
    }
    if (requestParameters.patient === null || requestParameters.patient === void 0) {
      throw new RequiredError("patient", "Required parameter requestParameters.patient was null or undefined when calling updatePatient.");
    }
    const queryParameters = {};
    const headerParameters = {};
    headerParameters["Content-Type"] = "application/json";
  ...
  async updateStatustrackingRaw(requestParameters) {
    if (requestParameters.id === null || requestParameters.id === void 0) {
      throw new RequiredError("id", "Required parameter requestParameters.id was null or undefined when calling updateStatustracking.");
    }
    if (requestParameters.statustracking === null || requestParameters.statustracking === void 0) {
      throw new RequiredError("statustracking", "Required parameter requestParameters.statustracking was null or undefined when calling updateStatustracking.");
    }
    const queryParameters = {};
    const headerParameters = {};
    headerParameters["Content-Type"] = "application/json";
  ...
  async updateTreatmentRaw(requestParameters) {
    if (requestParameters.id === null || requestParameters.id === void 0) {
      throw new RequiredError("id", "Required parameter requestParameters.id was null or undefined when calling updateTreatment.");
    }
    if (requestParameters.treatment === null || requestParameters.treatment === void 0) {
      throw new RequiredError("treatment", "Required parameter requestParameters.treatment was null or undefined when calling updateTreatment.");
    }
    const queryParameters = {};
    const headerParameters = {};
    headerParameters["Content-Type"] = "application/json";
...
function ComponentsTable() {
  ...
  return /* @__PURE__ */ React__default.createElement(TableContainer2, {
    ...
    align: "center"
  }, "ชื่อ-นามสกุล"), /* @__PURE__ */ React__default.createElement(TableCell2, {
    align: "center"
  }, "อายุ"), /* @__PURE__ */ React__default.createElement(TableCell2, {
    align: "center"
  }, "อาการ"), /* @__PURE__ */ React__default.createElement(TableCell2, {
    align: "center"
  }, "สถานะ"), /* @__PURE__ */ React__default.createElement(TableCell2, {
    align: "center"
  }, "วันที่การนัดหมายครั้งต่อไป"), /* @__PURE__ */ React__default.createElement(TableCell2, {
    align: "center"
  }, "delete"))), /* @__PURE__ */ React__default.createElement(TableBody2, null, treatments.map((item) => {
    var _a, _b, _c, _d, _e, _f;
    return /* @__PURE__ */ React__default.createElement(TableRow2, {
      key: item.id
    }, /* @__PURE__ */ React__default.createElement(TableCell2, {
      align: "center"
    }, item.id), /* @__PURE__ */ React__default.createElement(TableCell2, {
      align: "center"
    }, (_b = (_a = item.edges) == null ? void 0 : _a.patientID) == null ? void 0 : _b.patientName), /* @__PURE__ */ React__default.createElement(TableCell2, {
      align: "center"
    }, (_d = (_c = item.edges) == null ? void 0 : _c.patientID) == null ? void 0 : _d.patientAge), /* @__PURE__ */ React__default.createElement(TableCell2, {
      align: "center"
    }, item.symptom), /* @__PURE__ */ React__default.createElement(TableCell2, {
      align: "center"
    }, (_f = (_e = item.edges) == null ? void 0 : _e.statusID) == null ? void 0 : _f.status), /* @__PURE__ */ React__default.createElement(TableCell2, {
      align: "center"
    }, moment(item.dateAppoint).format("DD/MM/YYYY")), /* @__PURE__ */ React__default.createElement(TableCell2, {
      align: "center"
...
const WelcomePage = () => {
  ...
  return /* @__PURE__ */ React__default.createElement(Page, {
    ...
    title: `Welcome ${profile.givenName }`,
    ...
    variant: "contained",
    color: "primary"
  }, "Add Data")), "     ", /* @__PURE__ */ React__default.createElement(Button2, {
    variant: "outlined",
    color: "secondary",
    href: "#outlined-buttons"
  }, "LogOut")), /* @__PURE__ */ React__default.createElement(ComponentsTable, null)));
};
...
const username$1 = {givenuser: "นพ.เอื้อสีวงศ์ มะม่วงร่วง"};
function Create() {
  ...
  const CreateTreatment = async () => {
    ...
    const res = await api.createTreatment({treatment});
    setStatus(true);
    if (res.id != "") {
      setAlert(true);
    } else {
  ...
  return /* @__PURE__ */ React__default.createElement(Page, {
    ...
    title: `Welcome ${profile.givenName }`,
    subtitle: `${username$1.givenuser}`
  }), /* @__PURE__ */ React__default.createElement(Content, null, /* @__PURE__ */ React__default.createElement(ContentHeader, {
    title: "ระบบลงทะเบียนประวัติการรักษา"
  }, /* @__PURE__ */ React__default.createElement(Button2, {
    variant: "outlined",
    color: "secondary",
    href: "#outlined-buttons"
  }, "LogOut"), status ? /* @__PURE__ */ React__default.createElement("div", null, alert ? /* @__PURE__ */ React__default.createElement(Alert$1, {
    severity: "success"
    ...
    noValidate: true,
    autoComplete: "off"
  }, /* @__PURE__ */ React__default.createElement("div", null, /* @__PURE__ */ React__default.createElement(FormControl2, {
    className: classes.margin,
    variant: "outlined"
  }, /* @__PURE__ */ React__default.createElement(InputLabel2, {
    id: "doctor_id-label"
  }, "Doctor_ID"), /* @__PURE__ */ React__default.createElement(Select2, {
    ...
    style: {width: 600}
  }, users.map((item) => /* @__PURE__ */ React__default.createElement(MenuItem2, {
    value: item.id
  }, item.doctorName))))), /* @__PURE__ */ React__default.createElement("div", null, /* @__PURE__ */ React__default.createElement(FormControl2, {
    className: classes.margin,
    variant: "outlined"
  }, /* @__PURE__ */ React__default.createElement(InputLabel2, {
    id: "patient_id-label"
  }, "Patient_ID"), /* @__PURE__ */ React__default.createElement(Select2, {
    ...
    style: {width: 600}
  }, patients.map((item) => /* @__PURE__ */ React__default.createElement(MenuItem2, {
    value: item.id
  }, item.patientName))))), /* @__PURE__ */ React__default.createElement(FormControl2, {
    className: classes.margin,
    variant: "outlined"
    ...
    id: "status-label"
  }, "Status"), /* @__PURE__ */ React__default.createElement(Select2, {
    ...
    style: {width: 600}
  }, statuss.map((item) => /* @__PURE__ */ React__default.createElement(MenuItem2, {
    value: item.id
  }, item.status))))), /* @__PURE__ */ React__default.createElement(FormControl2, {
    className: classes.margin
  }, /* @__PURE__ */ React__default.createElement(TextField2, {
    id: "Appoint_date",
    label: "Appoint_date",
    ...
    variant: "contained",
    color: "primary"
  }, "Submit"), /* @__PURE__ */ React__default.createElement(Button2, {
    style: {marginLeft: 20},
    component: Link$1,
    to: "/",
    variant: "contained"
