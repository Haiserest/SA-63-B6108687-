...
export function EntUserEdgesFromJSONTyped(json: any, ignoreDiscriminator: boolean): EntUserEdges {
    ...
    return {
        ...
        'doctorID': !exists(json, 'doctorID') ? undefined : ((json['doctorID'] as Array<any>).map(EntTreatmentFromJSON)),
    };
}
...
export function EntUserEdgesToJSON(value?: EntUserEdges | null): any {
    ...
    return {
        ...
        'doctorID': value.doctorID === undefined ? undefined : ((value.doctorID as Array<any>).map(EntTreatmentToJSON)),
    };
}
